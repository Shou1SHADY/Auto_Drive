...
def decision_step(Rover):
    ...
    if Rover.total_time >= 0 and Rover.total_time <= 5 : 
        gh =round(Rover.pos[0])     
        gj =round(Rover.pos[1])   
        position.append([gh,gj])
        i=i+1 
    ...
    if Rover.nav_angles is not None:
        ...
        if Rover.mode[-1] == 'forward':      
            if Rover.total_time != 0 and Rover.samples_collected > 4 :
                   for j in position :
                      if round(Rover.pos[0]) == j[0] and round(Rover.pos[1]) == j[1]:
                         Rover.throttle = 0
        ...
        ######################################        
            ...
            # if got stuck go to stuck mode
                ...
                # Approach slowly
                slow_speed = Rover.max_vel / 2 + 0.5
